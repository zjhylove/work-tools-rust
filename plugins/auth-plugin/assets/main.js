...
function App() {
  ...
  const [totpMap, setTotpMap] = reactExports.useState({});
  ...
  const loadEntries = () => __async(this, null, function* () {
    var _a;
    try {
      setLoading(true);
      const result = yield (_a = window.pluginAPI) == null ? void 0 : _a.call(
        "auth",
        "list_entries",
        {}
      );
  ...
  const generateTotp = reactExports.useCallback(
    (entry, forceRefresh = false) => __async(this, null, function* () {
      var _a;
      try {
        if (forceRefresh) {
          yield new Promise((resolve) => setTimeout(resolve, 100));
        }
        const code = yield (_a = window.pluginAPI) == null ? void 0 : _a.call("auth", "generate_totp", {
          secret: entry.secret,
          digits: entry.digits,
          period: entry.period
        });
        const now2 = Math.floor(Date.now() / 1e3);
        const remaining = entry.period - now2 % entry.period;
        setTotpMap((prev) => __spreadProps(__spreadValues({}, prev), {
  ...
  const refreshAllCodes = reactExports.useCallback(() => {
  ...
  const saveEntry = () => __async(this, null, function* () {
    ...
    try {
      ...
      let savedEntry = null;
      if (viewMode === "add") {
        savedEntry = yield (_a = window.pluginAPI) == null ? void 0 : _a.call("auth", "add_entry", {
          entry: __spreadProps(__spreadValues({}, formData), {
            id: "",
            // 后端会生成
        ...
        savedEntry = yield (_b = window.pluginAPI) == null ? void 0 : _b.call("auth", "update_entry", {
          entry: __spreadProps(__spreadValues({}, formData), {
            id: selectedEntry.id,
  ...
  const deleteEntry = () => __async(this, null, function* () {
    ...
    try {
      yield (_a = window.pluginAPI) == null ? void 0 : _a.call("auth", "delete_entry", {
        id: selectedEntry.id
      });
      yield loadEntries();
  ...
  const generateSecret = () => __async(this, null, function* () {
    var _a;
    try {
      const secret = yield (_a = window.pluginAPI) == null ? void 0 : _a.call(
        "auth",
        "generate_secret",
        {}
      );
      setFormData((prev) => __spreadProps(__spreadValues({}, prev), { secret }));
      setFieldErrors((prev) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-plugin", children: [
    ...
    (viewMode === "add" || viewMode === "edit") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "auth-form-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "auth-form-content", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "发行方 *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-with-button", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "算法" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "SHA1", children: "SHA1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "SHA256", children: "SHA256" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "SHA512", children: "SHA512" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "位数" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "周期(秒)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
